 ...
 */
public class OpenAPIClassWriter extends BaseClassWriter implements IAtomicServiceWriter, IScenarioWriter, IRoleMapperWriter {
    public OpenAPIClassWriter(File domainPath, SppClass sppClass, String basePackage, String javaPackage) {
