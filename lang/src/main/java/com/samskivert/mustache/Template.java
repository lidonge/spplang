...
public class Template {
    ...
    protected Object getValue (Context ctx, String name, int line, boolean missingIsNull) {
        return getValue(ctx,name,line,missingIsNull,false);
    }
    protected Object getValue (Context ctx, String name, int line, boolean missingIsNull, boolean isRecursion) {
    ...
    protected Object getSectionValue (Context ctx, String name, int line) {
        return getSectionValue(ctx,name,line,false);
    }
    protected Object getSectionValue (Context ctx, String name, int line, boolean isRecursion) {
        Object value = getValue(ctx, name, line, !_compiler.strictSections, isRecursion);
