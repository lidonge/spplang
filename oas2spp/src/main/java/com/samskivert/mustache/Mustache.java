...
public class Mustache {
    ...
    public static class Compiler {
        ...
        public Compiler sectionListener(SectionListener sectionListener){
    ...
    protected static class SectionSegment extends BlockSegment {
        ...
        @Override public void execute (Template tmpl, Template.Context ctx, Writer out) {
            ...
            if (_comp.sectionListener != null){
                value = _comp.sectionListener.onGetSectionValue(value,tmpl, this._name);
            }
            ...
            if (iter != null) {
                ...
                if(iter.hasNext()){
                    ...
                    while (iter.hasNext()) {
                        ...
                        if(_comp.sectionListener!= null){
                            elem = _comp.sectionListener.onSectionNext(elem, tmpl,this._name);
                        }
